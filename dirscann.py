...
wl = open(r'C:\Users\mpmep\OneDrive\Escritorio\Shortcuts\Work\Hacking\TDI_Python\Wordlists\wordlist.txt')
#You have to type the whole path to the file, or if it is in the same directory, you could just type the file name
wordlist = wl.readlines()

dns = open(r'C:\Users\mpmep\OneDrive\Escritorio\Shortcuts\Work\Hacking\TDI_Python\Wordlists\subdomain.txt')
